...
class _UserFollowWidgetState extends State<UserFollowWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.isFollowingComponent = widget.user!.isFollowing;
      safeSetState(() {});
    });
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                FFButtonWidget(
                  onPressed: () async {
                    if (_model.isFollowingComponent) {
                      ...
                      _model.isFollowingComponent = false;
                      safeSetState(() {});
                    } else {
                      ...
                      _model.isFollowingComponent = true;
                      safeSetState(() {});
                    }
                  },
                  text: valueOrDefault<String>(
                    _model.isFollowingComponent ? 'Following' : 'Follow',
                    'Follow',
                  ),
