          ...
          child: Column(
            ...
            children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                functions
                                    .getStringUrl(widget.user?.avatarUrl)!,
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  FollowsWidget.routeName,
                                  queryParameters: {
                                    'isFollowers': serializeParam(
                                      true,
                                      ParamType.bool,
                                    ),
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final listPosts = _model.profilePosts.toList();
                      ...
                      itemBuilder: (context, listPostsIndex) {
                        ...
                        return InkWell(
                          ...
                          child: CustomPostFeedWidget(
                            key: Key(
                                'Keyuhz_${listPostsIndex}_of_${listPosts.length}'),
