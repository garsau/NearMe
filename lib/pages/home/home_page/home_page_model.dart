...
class HomePageModel extends FlutterFlowModel<HomePageWidget> {
  ...
  // Model for CustomPostMap component.
  late CustomPostMapModel customPostMapModel;
  ...
  void initState(BuildContext context) {
    customPostMapModel = createModel(context, () => CustomPostMapModel());
