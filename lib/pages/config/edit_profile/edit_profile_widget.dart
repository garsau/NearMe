...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: FFAppState().userProfile.username);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: FFAppState().userProfile.bio);
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadAvatar = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadAvatar = false;
                                  }
                              ...
                              child: Container(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: functions.getStringUrl(
                                      FFAppState().userProfile.avatarUrl)!,
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
